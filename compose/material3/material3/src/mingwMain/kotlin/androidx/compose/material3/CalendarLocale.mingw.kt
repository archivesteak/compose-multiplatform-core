 ...
 *
 * Compose's own locale carries a BCP47 language tag, which is exactly what the Win32 NLS functions
 * take as a locale name, so no separate platform locale type is needed.
 */
